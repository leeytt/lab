									...
									<c:choose>
										...
										<c:otherwise>
											<c:forEach items="${pageInfo.list}" var="entity" varStatus="status" >
												<tr>
													<td><input type="checkbox" class="fill listen-1-2" name="id" value="${entity.tip_Id}"/> </td>
								...
								<c:otherwise>
									<div class="block no-shadow">
										...
										<div class="main" style="margin-bottom:100px;">
											...
											<br/>
											<label zoom="1.1"><input type="radio" class="fill" name="radio" value="delete"/>批量删除</label>
											<br/>
