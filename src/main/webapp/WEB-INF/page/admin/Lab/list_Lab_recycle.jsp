									...
									<c:choose>
										...
										<c:otherwise>
											<c:forEach items="${pageInfo.list}" var="entity" varStatus="status" >
												<tr>
													<td><input type="checkbox" class="fill listen-1-2" name="id" value="${entity.lab_Id}"/> </td>
								...
								<c:otherwise>
									<div class="block no-shadow">
										...
										<div class="main" style="margin-bottom:200px;">
											<label zoom="1.1"><input type="radio" class="fill" name="radio" value="back"/>批量还原</label>
											<br/>
											<label zoom="1.1"><input type="radio" class="fill" name="radio" value="delete"/>彻底删除</label>
											<br/>
											<button style="margin-top:10px;" id="submit" class="button green"><span class="icon-check"></span> 提交</button>
										</div>
									</div>
								</c:otherwise>
							</c:choose>
...
<script>
	...
	function search(pageNum) {
		...
		//分页
		window.location.href = "list_Lab_recycle.action"
		+ "?pageNum="+pageNum
