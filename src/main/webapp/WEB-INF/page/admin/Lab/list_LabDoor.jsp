							...
							<table id="table" class="table">
								...
								<tbody>
									<c:forEach items="${list}" var="entity" varStatus="status" >
										<tr>
											<td><input type="checkbox" class="fill listen-1-2" name="id" value="${entity.labDoor_Id}"/> </td>
											<td><input type="text" class="text" name="name" data-type="必填" placeholder="请输入门牌号" value="${entity.doorName}"/></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
...
<script>
	...
	$("#add").click(function() {
		var html = '';
		html += '<tr>';
		html += '<td><input type="checkbox" class="fill listen-1-2" name="id" value="${entity.labDoor_Id}"/> </td>';
		html += '<td><input type="text" class="text" name="name" data-type="必填" placeholder="请输入门牌号" value="${entity.doorName}"/></td>';
		html += '</tr>';
